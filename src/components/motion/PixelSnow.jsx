...
export default function PixelSnow({
  ...
  }, [coarsePointer, handleResize, reducedMotion]); // Only recreate scene when handleResize changes
  ...
  return <div ref={containerRef} className={`pixel-snow-container ${reducedMotion || coarsePointer ? 'pixel-snow-static' : ''} ${className}`} style={style} aria-hidden="true" />;
}
